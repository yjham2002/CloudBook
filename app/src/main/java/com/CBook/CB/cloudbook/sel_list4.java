...
public class sel_list4 extends AsyncTask<Void, Void, Void> {
    public String line2=null, result2=null;
    public InputStream is2=null;
    private AsyncCallback refreshCall;
    public sel_list4(AsyncCallback refreshCall)
    {
    ...
    protected Void doInBackground(Void... arg0) {
        ...
        try {
            ...
            HttpPost httppost2 = new HttpPost("http://yjham2002.woobi.co.kr/cb_directory/getMyArticles.php");
        ...
        try {
            staticInfo.mAdapterMe.mListData.clear();
            ...
            for(int i = 0; i < ART_CNT2 ; i++){
                ...
                staticInfo.mAdapterMe.addItem(json_list2.getString("id"),json_list2.getString("dt"),json_list2.getString("ct"),Integer.parseInt(json_list2.getString("ix")),json_list2.getString("tk"),Integer.parseInt(json_list2.getString("tf"))

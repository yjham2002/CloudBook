...
public class sel_list3 extends AsyncTask<Void, Void, Void> {
    public String line2=null, result2=null;
    public InputStream is2=null;
    private AsyncCallback refreshCall;
    public sel_list3(AsyncCallback refreshCall)
    {
    ...
    protected Void doInBackground(Void... arg0) {
            ...
            nameValuePairs.add(new BasicNameValuePair("id", staticInfo.getID()));
        try {
            staticInfo.async = 0;
            HttpClient httpclient2 = new DefaultHttpClient();
            HttpPost httppost2 = new HttpPost("http://yjham2002.woobi.co.kr/cb_directory/getArticlesByMe.php");
        ...
        try {
            staticInfo.mAdaptergo.mListData.clear();
            ...
            for(int i = 0; i < ART_CNT2 ; i++){
                ...
                staticInfo.mAdaptergo.addItem(json_list2.getString("id"),json_list2.getString("dt"),json_list2.getString("ct"),Integer.parseInt(json_list2.getString("ix")),json_list2.getString("tk"),Integer.parseInt(json_list2.getString("tf"))
